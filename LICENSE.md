...
This license applies to the original MarsOS components only,
including but not limited to: build scripts, configuration
files, overlay files, branding assets, and custom applications
(e.g., dock). Upstream software distributed as part of MarsOS
(such as Debian packages, KDE Plasma, the Linux kernel, and
other third-party components) retains its original license
terms (GPL, LGPL, MIT, BSD, etc.). Nothing in this license
is intended to impose additional restrictions on software
already licensed under open-source terms.
...
> Required Notice: Copyright Advait Bansode (https://github.com/advait1306)
